...
(function() {
   ...
   */
  angular.module('directive.datepicker', [
    'material.core',
    'material.components.icon',
    'material.components.virtualRepeat'
  ]).directive('ppCalendar', calendarDirective);
...
(function() {
  ...
  angular.module('directive.datepicker')
      .directive('ppCalendarMonth', mdCalendarMonthDirective);
  ...
  function mdCalendarMonthDirective() {
    return {
      require: ['^^ppCalendar', 'ppCalendarMonth'],
...
(function() {
  ...
  angular.module('directive.datepicker').config(["$provide", function($provide) {
    ...
    DateLocaleProvider.prototype.$get = function($locale) {
      ...
      function defaultFormatDate(date) {
        ...
        if (date.getHours() === 0 &&
          ...
          formatDate = new Date(date.getFullYear(), date.getMonth(), date.getDate(), date.getHours()+1, date.getMinutes(), 0);
        }
...
(function() {
  ...
  angular.module('directive.datepicker')
      .directive('ppDatepicker', datePickerDirective);
    ...
    return {
      template:
          ...
          '<md-input-container class="md-block">' +
            ...
            '<input type="text" aria-haspopup="true" ng-model="ctrl.selectedDate" ng-click="ctrl.openCalendarPane($event)" readonly>' +
          '</md-input-container>' +
          ...
          '<div class="md-datepicker-calendar-pane md-whiteframe-z1">' +
            ...
            '</div>' +
          '</div>',
      require: ['ngModel', 'ppDatepicker', '?^mdInputContainer'],
      scope: {
        minDate: '=mdMinDate',
        maxDate: '=mdMaxDate',
  ...
  function DatePickerCtrl($scope, $element, $attrs, $compile, $timeout, $window,
    ...
    /** @type {HTMLInputElement} */
    this.labelElement = $element[0].querySelector('label');

    /** @final {!angular.JQLite} */
    this.ngInputElement = angular.element(this.inputElement);

    /** @type {HTMLElement} */
    this.inputContainer = $element[0].querySelector('md-input-container');
  ...
  DatePickerCtrl.prototype.configureNgModel = function(ngModelCtrl) {
    ...
    ngModelCtrl.$render = function() {
      ...
      self.selectedDate = self.dateLocale.formatDate(value);
  ...
  DatePickerCtrl.prototype.attachCalendarPane = function() {
    ...
    var labelRect = this.labelElement.getBoundingClientRect();

    var bodyRect = document.body.getBoundingClientRect();

    // Check to see if the calendar pane would go off the screen. If so, adjust position
    // accordingly to keep it within the viewport.
    var paneTop = (labelRect.top - 5) - bodyRect.top;
    var paneLeft = (labelRect.left - 5) - bodyRect.left;
...
(function() {
   ...
   * datepicker.
   */
  angular.module('directive.datepicker').factory('$$mdDateUtil', function() {
    return {
    ...
    /**
     * Gets whether two dates are the same day.
     * @param {Date} d1
     * @param {Date} d2
     * @returns {boolean}
     */
    function isSameDay(d1, d2) {
      return d1.getDate() === d2.getDate() && isSameMonthAndYear(d1, d2);
        ...
        /**
     * Gets whether two dates are the same time.
     * @param {Date} d1
     * @param {Date} d2
     * @returns {boolean}
     */
    function isSameTime(d1, d2) {
      return d1.getHours() === d2.getHours() && d1.getMinutes() === d2.getMinutes() && isSameDay(d1, d2);
    }
