...
angular.module('angular-loading-bar', ['loadingBarInterceptor']);

angular.module('loadingBarInterceptor', ['loadingBar'])
...
angular.module('loadingBar', [])
  .provider('loadingBar', function() {
    ...
    this.loadingBarTemplate = '<div class="loading-bar"><div class="bar"><div class="peg"></div></div></div>';
