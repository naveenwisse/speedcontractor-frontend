(function() {
    ...
    angular
        .module('md.calendar')
        .controller('MdCalendarMonthCtrl', function($scope, calendarHelper, calendarConfig) {
        ...
        .directive('mdLargeCalendarMonth', function() {

            return {
                templateUrl: 'calendar/calendarMonthView.html',
                restrict: 'EA',
