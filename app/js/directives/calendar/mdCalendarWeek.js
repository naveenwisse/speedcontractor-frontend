(function() {
    ...
    angular
        .module('md.calendar')
        .controller('MdCalendarWeekCtrl', function($scope, $sce, calendarHelper, calendarConfig) {
        ...
        .directive('mdCalendarWeek', function() {

            return {
                templateUrl: 'calendar/calendarWeekView.html',
                restrict: 'EA',
